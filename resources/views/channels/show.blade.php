                            ...
                            <form action="{{ route('channels.update', $channel->id) }}" method="post"
                                    ...
                                    <div class="text-center">
                                        <subscribe-button :channel="{{ $channel }}"
                                            ...
                                            <button @click="toggleSubscription" class="btn btn-danger">
                                                {{-- @ will prevent laravel from rendering '{{  }}' as laravel sign--}}
                                ...
                                @if($channel->editable())
                                    <input onchange="document.getElementById('update-channel-form').submit()"
                                           class="invisible" accept="image/*" type="file" name="image" id="image">
                                    ...
                                    <button class="btn btn-info" type="submit">{{ __('Update Channel') }}</button>
                            </form>
                        @endif
                    </div>
                </div>
